...
void runAnalysisTrainJoey(const Char_t* infile="/alice/data/current.txt", const Char_t* runmode = "local", const Char_t* inputType="reducedEvent", Bool_t hasMC = kFALSE, // Bool_t isInjected = kFALSE,
//void runAnalysisTrainJoey(const Char_t* infile="events_mc.txt", const Char_t* runmode = "local", const Char_t* inputType="reducedEvent", Bool_t hasMC = kTRUE, // Bool_t isInjected = kFALSE,
